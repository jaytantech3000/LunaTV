...
- attach a Windows `.zip` portable package
...
- Asset labels: shown as `macOS Intel - ...`, `macOS Apple Silicon - ...`, or `Windows x64 - ...`
- Download file names: keep normalized updater-safe names such as `LunaTV.Desktop_<version>_x64_portable.zip`

...
- 桌面下载执行器现已固定收口到 Rust：桌面 dev/build 不再暴露 TS compat 开关，`DownloadsClient` 设置页只保留 Rust 本地运行时与 Web 离线缓存两种展示语义。
- Phase 1 清单现已全部完成；后续收尾重点转向 Phase 2、Phase 3 与 Phase 4。

          ...
          return (
            ...
            >
              <div className='relative aspect-[4/3] overflow-hidden'>
                ...
                <div className='absolute right-4 top-4 flex h-11 w-11 items-center justify-center rounded-full bg-white/18 text-white backdrop-blur transition-transform duration-200 group-hover:scale-105'>

...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    added: {
      ...
      en: [
        'Add an admin panel toggle to disable web live streaming.',
      ],
    },
    changed: {
      zhCN: [
  ...
  },
  {
    ...
    fixed: {
      ...
      en: [
        'Fix a player controls display bug in WebKit.',
      ],
    },
  },
  {
    ...
    fixed: {
      ...
      en: [
        'Fix an unauthorized access issue in `/api/search/resources`.',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    added: {
      ...
      en: [
        'Support adding IPTV channels to favorites.',
      ],
    },
    changed: {
      zhCN: [
  ...
  },
  {
    ...
    changed: {
      ...
      en: [
        'Add loading-state UI to buttons in the admin page.',
      ],
    },
    fixed: {
      zhCN: [
  ...
  },
  {
    ...
    changed: {
      ...
      en: [
        'Add support for `url-tvg` and multiple EPG URLs.',
      ],
    },
    fixed: {
      zhCN: [
  ...
  },
  {
    ...
    changed: {
      ...
      en: [
        'Refresh live source data concurrently.',
      ],
    },
    fixed: {
      zhCN: [
  ...
  },
  {
    ...
    added: {
      ...
      en: [
        'Add IPTV subscription and playback support.',
      ],
    },
    changed: {
      zhCN: [
  ...
  },
  {
    ...
    fixed: {
      ...
      en: [
        'Fix an issue where video cards could not be clicked on mobile.',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    changed: {
      ...
      en: [
        'Optimize the machine identifier generation logic.',
      ],
    },
    fixed: {
      zhCN: [
  ...
  },
  {
    ...
    fixed: {
      ...
      en: [
        'Fix an authorization initialization error.',
      ],
    },
  },
  {
    ...
    changed: {
      ...
      en: [
        'Open an action menu by right-clicking a video card.',
      ],
    },
    fixed: {
      zhCN: [
      ...
      en: [
        'Filter out search results whose episode count is `0`.',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    changed: {
      ...
      en: [
        'Optimize episode title matching and display logic.',
      ],
    },
    fixed: {
      zhCN: [
  ...
  },
  {
    ...
    added: {
      ...
      en: [
        'Support Kvrocks storage as a persistent KV backend.',
      ],
    },
    changed: {
      zhCN: [
  ...
  },
  {
    ...
    added: {
      ...
      en: [
        'Support full-site data import and export for the site owner.',
      ],
    },
    changed: {
      zhCN: [
  ...
  },
  {
    ...
    added: {
      ...
      en: [
        'Support fetching config files through subscriptions.',
      ],
    },
    changed: {
      zhCN: [
  ...
  },
  {
    ...
    changed: {
      ...
      en: [
        'Route version checks and changelog requests through GitHub.',
      ],
    },
    fixed: {
      zhCN: [
      ...
      en: [
        'Fine-tune the admin panel styles.',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    fixed: {
      ...
      en: [
        '[Ops] Use the UTC+8 date for Docker workflow releases.',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    changed: {
      ...
      en: [
        'Implement an automatic release workflow based on Git tags.',
      ],
    },
    fixed: {
      zhCN: [
  ...
  },
  {
    ...
    changed: {
      ...
      en: [
        'Upgrade the player `Artplayer` to version `5.2.5`.',
      ],
    },
    fixed: {
      zhCN: [

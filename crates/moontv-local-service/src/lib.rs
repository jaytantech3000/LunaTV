...
#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
struct PlaybackSourcePrefetchRequest {
    title: String,
    year: Option<String>,
    search_type: Option<String>,
    query: Option<String>,
    douban_id: Option<i64>,
    allow_adult_candidates: Option<bool>,
}
...
async fn search_playback_sources(
    State(state): State<AppState>,
...
fn build_playback_search_queries(params: &PlaybackSourcePrefetchRequest) -> Vec<String> {
    let year = params
        .year
        .as_deref()
        .unwrap_or_default()
...
fn filter_playback_search_results(
    results: Vec<SearchResult>,
    params: &PlaybackSourcePrefetchRequest,
) -> Vec<SearchResult> {
